...
public class BaseTbgCustAddressEntityVO extends BaseEntityVO
{

  private Long m_custNbr;
  ...
  /**
   * @param addrCityText_ Field addrCityText to be setted.
   */
  ...
  /**
   * @param addrCmplText_ Field addrCmplText to be setted.
   */
  ...
  /**
   * @param addrCntryCode_ Field addrCntryCode to be setted.
   */
  ...
  /**
   * @return Returns addrContactName.
   */
  ...
  /**
   * @param addrContactName_ Field addrContactName to be setted.
   */
  ...
  /**
   * @param addrNameText_ Field addrNameText to be setted.
   */
  ...
  /**
   * @param addrNeighbText_ Field addrNeighbText to be setted.
   */
  ...
  /**
   * @param addrSeqNbr_ Field addrSeqNbr to be setted.
   */
  ...
  /**
   * @param addrStateCode_ Field addrStateCode to be setted.
   */
  ...
  /**
   * @param cellAreaCode_ Field cellAreaCode to be setted.
   */
  ...
  /**
   * @param cellOpCode_ Field cellOpCode to be setted.
   */
  ...
  /**
   * @param cellPhoneNbr_ Field cellPhoneNbr to be setted.
   */
   ...
   */
  public void setCustNbr( Long custNbr_ )
  {
    m_custNbr = custNbr_;
  }
  /**
  ...
  /**
   * @param emailText_ Field emailText to be setted.
   */
  ...
  /**
   * @param faxAreaCode_ Field faxAreaCode to be setted.
   */
  ...
  /**
   * @param faxNbr_ Field faxNbr to be setted.
   */
  ...
  /**
   * @param mailBoxNbr_ Field mailBoxNbr to be setted.
   */
  ...
  /**
   * @param phoneAreaCode_ Field phoneAreaCode to be setted.
   */
  ...
  /**
   * @param phoneOpCode_ Field phoneOpCode to be setted.
   */
  ...
  /**
   * @param telexAreaCode_ Field telexAreaCode to be setted.
   */
  ...
  /**
   * @param telexNbr_ Field telexNbr to be setted.
   */
  ...
  /**
   * @param zipCode_ Field zipCode to be setted.
   */
  ...
  /**
   * @return Returns zipCodeChangeText.
   */
  ...
  /**
   * @param zipCodeChangeText_ Field zipCodeChangeText to be setted.
   */
  ...
  /**
   * @param zipExtnCode_ Field zipExtnCode to be setted.
   */
