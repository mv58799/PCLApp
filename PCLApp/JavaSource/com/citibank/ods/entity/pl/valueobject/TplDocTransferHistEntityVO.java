...
public class TplDocTransferHistEntityVO extends BaseTplDocTransferEntityVO
{
  private Date m_docTrfRefDate;
  ...
  /**
   * @return Returns docTrfRefDate.
   */
  public Date getDocTrfRefDate()
  {
    return m_docTrfRefDate;
  }
  /**
   * @param docTrfRefDate_ Field docTrfRefDate to be setted.
   */
  public void setDocTrfRefDate( Date docTrfRefDate_ )
  {
    m_docTrfRefDate = docTrfRefDate_;
  }
  /**
