 ...
 */
public class TplOfficerCmplHistoryEntityVO extends BaseTplOfficerCmplEntityVO {
  
  private Date m_lastAuthDate;
  private String m_lastAuthUserId;
  private String m_recStatCode;
  private Date m_offcrRefDate;
  /**
  ...
  /**
   * @return Returns offRefDate.
   */
  public Date getOffcrRefDate()
  {
    return m_offcrRefDate;
  }
  /**
   * @param offRefDate_ Field offRefDate to be setted.
   */
  public void setOffcrRefDate( Date offcrRefDate_ )
  {
