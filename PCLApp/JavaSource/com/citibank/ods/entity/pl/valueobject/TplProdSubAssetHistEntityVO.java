 ...
 * @since 06/10/2008
 */
public class TplProdSubAssetHistEntityVO extends BaseTplProdSubAssetEntityVO
{
	/**
	...
	/**
	 * Comment for <code>m_assetClassRefDate</code>
	 * @generated "UML to Java (com.ibm.xtools.transform.uml2.java.internal.UML2JavaTransform)"
	 */
	private Date m_subAssetRefDate;
	...
	/**
	 * @return Returns the m_subAssetRefDate.
	 */
	public Date getSubAssetRefDate() {
		return m_subAssetRefDate;
	}

	/**
	 * @param m_subAssetRefDate to set.
	 */
	public void setSubAssetRefDate(Date subAssetRefDate_) {
		m_subAssetRefDate = subAssetRefDate_;
	}
