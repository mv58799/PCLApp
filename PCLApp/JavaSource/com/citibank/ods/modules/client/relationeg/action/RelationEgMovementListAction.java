...
import com.citibank.ods.modules.client.relationeg.functionality.RelationEgMovementListFnc;
...
public class RelationEgMovementListAction extends BaseODSListAction
{

  /*
   * Parte do nome do módulo ou ação
   */
  private static final String C_SCREEN_NAME = "RelationEg.RelationEgMovementList";
  ...
  {
    return RelationEgMovementListFncVO.class.getName();
  }
  ...
  {
    return new RelationEgMovementListFnc();
  }
  ...
  {
    RelationEgMovementListFncVO fncVO = ( RelationEgMovementListFncVO ) fncVO_;
