...
public class FundSubscriptionFundCodeUpdateFnc extends BaseFnc{

	@Override
	public BaseFncVO createFncVO() {
		return new FundSubscriptionFundCodeUpdateFncVO();
	}

	public void clearPage(BaseFncVO fncVO_) {
		FundSubscriptionFundCodeUpdateFncVO fnc = ( FundSubscriptionFundCodeUpdateFncVO ) fncVO_;
