...
public class BrokerHistoryDetailForm extends BaseBrokerDetailForm
{
  ...
  private String m_bkrRefDate = "";

  /**
   * @return Returns m_bkrRefDate.
   */
  public String getBkrRefDate()
  {
    return m_bkrRefDate;
  }

  /**
   * @param bkrRefDate_ Field m_bkrRefDate to be setted.
   */
  public void setBkrRefDate( String bkrRefDate_ )
  {
