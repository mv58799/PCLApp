...
import com.citibank.ods.modules.product.prodriskcatprvt.functionality.ProdRiskCatPrvtListFnc;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ProdRiskCatPrvtListAction extends BaseODSListAction
{
  /*
   * Parte do nome do módulo ou ação
   */
  private static final String C_SCREEN_NAME = "ProdRiskCatPrvt.ProdRiskCatPrvtList";
  ...
  {
    return new ProdRiskCatPrvtListFnc();
  }
  ...
  {
    return ProdRiskCatPrvtListFnc.class.getName();
  }
