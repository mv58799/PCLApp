...
import com.citibank.ods.modules.product.productfamilyprvt.functionality.ProductFamilyPrvtMovementDetailFnc;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ProductFamilyPrvtMovementDetailAction extends
    BaseODSMovementDetailAction
{
  /*
   * Parte do nome do módulo ou ação
   */
  private static final String C_SCREEN_NAME = "ProductFamilyPrvt.ProductFamilyPrvtMovementDetail";
  ...
  {
    return new ProductFamilyPrvtMovementDetailFnc();
  }
  ...
  {
    return ProductFamilyPrvtMovementDetailFncVO.class.getName();
  }
