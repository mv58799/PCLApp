...
import com.citibank.ods.modules.product.productfamilyprvt.functionality.ProductFamilyPrvtListFnc;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ProductFamilyPrvtListAction extends BaseODSListAction
{
  /*
   * Parte do nome do módulo ou ação
   */
  private static final String C_SCREEN_NAME = "ProductFamilyPrvt.ProductFamilyPrvtList";
  ...
  {
    return new ProductFamilyPrvtListFnc();
  }
  ...
  {
    return ProductFamilyPrvtListFncVO.class.getName();
  }
