...
import com.citibank.ods.modules.product.productfamilyprvt.functionality.ProductFamilyPrvtDetailFnc;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ProductFamilyPrvtDetailAction extends BaseODSDetailAction
{
  /*
   * Parte do nome do módulo ou ação
   */
  private static final String C_SCREEN_NAME = "ProductFamilyPrvt.ProductFamilyPrvtDetail";
  ...
  {
    return new ProductFamilyPrvtDetailFnc();
  }
  ...
  {
    return ProductFamilyPrvtDetailFncVO.class.getName();
  }
