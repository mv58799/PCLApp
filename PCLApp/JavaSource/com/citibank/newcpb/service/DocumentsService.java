...
import com.citibank.newcpb.persistence.dao.TplPrvtDocumentsDAO;
...
public class DocumentsService extends CommonService{
	
	private TplPrvtDocumentsDAO dao;
	...
	public ArrayList<DocumentsVO> listCad(String filterCpfCnpj, String filterName, String filterTitulo, boolean isLike) throws ParseException {

		ArrayList<DocumentsVO> resultList = dao.list(filterCpfCnpj, filterName, filterTitulo, isLike);
		
		/*if(resultList!=null && !resultList.isEmpty()){
			for (DocumentsVO documentsVO : resultList) {				
				ArrayList<AuthorizationPersonAccountVO> accountList = acctDao.list(documentsVO.getEmNbr(), null, false);
	...
	public ArrayList<DocumentsVO> listCadInsert(String filterCpfCnpj, String filterName, String getFilterProcPA) throws ParseException {

		ArrayList<DocumentsVO> resultList = dao.listInsert(filterCpfCnpj, filterName, getFilterProcPA);
