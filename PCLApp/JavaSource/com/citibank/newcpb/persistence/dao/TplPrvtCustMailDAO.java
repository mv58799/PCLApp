...
public class TplPrvtCustMailDAO extends BaseOracleDAO {
	...
	public void deleteByGFCID(String custGfcidNbr) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_MAIL WHERE CUST_GFCID_NBR = ? ");
	...
	public MailVO insert(MailVO vo) {
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_CUST_MAIL ( ");
	...
	public ArrayList<MailVO> list(String custGfcidNbr){
		...
		try {
			...
			sqlQuery.append(" FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_MAIL ");
