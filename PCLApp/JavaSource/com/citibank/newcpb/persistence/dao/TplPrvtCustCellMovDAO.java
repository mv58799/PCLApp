...
public class TplPrvtCustCellMovDAO extends BaseOracleDAO {
	...
	public void deleteByGFCID(String custGfcidNbr) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_CELL_MOV WHERE CUST_GFCID_NBR = ? ");
	...
	public ArrayList<TelephoneVO> list(String custGfcidNbr){
		...
		try {
			...
			query.append(" FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_CELL_MOV ");
	...
	public TelephoneVO insert(TelephoneVO vo) {
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_CUST_CELL_MOV ( ");
