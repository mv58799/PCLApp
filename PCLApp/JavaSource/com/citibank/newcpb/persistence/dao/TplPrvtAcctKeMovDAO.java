...
public class TplPrvtAcctKeMovDAO extends BaseOracleDAO {
	...
	public QuestionsKeVO insertAcctKe(QuestionsKeVO vo)  {
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_ACCT_KE_MOV ( ");
	...
	public QuestionsKeVO updateAcctKe(QuestionsKeVO vo)  {
		...
		try {
			...
			sqlQuery.append("UPDATE  " + C_PL_SCHEMA + "TPL_PRVT_ACCT_KE_MOV ");
			sqlQuery.append("  SET ");
			sqlQuery.append("  LAST_UPD_DATE                 = ? , ");
			sqlQuery.append("  LAST_UPD_USER                 = ? , ");
			sqlQuery.append("  LAST_AUTH_DATE                = ? , ");
	...
	public QuestionsKeVO getAcctKe(String acctNbr, String cpfCnpj)  {
		...
		try {
			...
			+ "   LAST_UPD_USER, "
			+ "   REC_STAT_CODE "
			+ " FROM " + C_PL_SCHEMA + "TPL_PRVT_ACCT_KE_MOV "
			+ " WHERE 1=1 ");			
	...
	public void deleteByAcctNbr(String acctNbr, String cpfCnpj) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_ACCT_KE_MOV WHERE ACCT_NBR = ? AND CUST_CPF_CNPJ_NBR = ?   ");
