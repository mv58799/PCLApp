...
public class TplPrvtCustCountryDAO extends BaseOracleDAO {
	...
	public void deleteByGFCID(String custGfcidNbr) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_COUNTRY WHERE CUST_GFCID_NBR = ? ");
	...
	public CustomerCountryVO insert(CustomerCountryVO vo) {
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_CUST_COUNTRY ( ");
	...
	public ArrayList<CustomerCountryVO> list(String custGfcidNbr){
		...
		try {
			...
			sqlQuery.append(" FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_COUNTRY ");
