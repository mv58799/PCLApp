...
public class TplPrvtErEmMovDAO extends BaseOracleDAO {

	public void deleteByEM(String emNbr) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_ER_EM_MOV WHERE EM_NBR = ? ");
	...
	public ErEmVO insert(ErEmVO vo) {
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_ER_EM_MOV ( ");
	...
	public ErEmVO getErEm(String emNbr){
		...
		try {
			...
			sqlQuery.append("    LAST_UPD_USER_ID, ");
			sqlQuery.append("    REC_STAT_CODE ");	
			sqlQuery.append(" FROM " + C_PL_SCHEMA + "TPL_PRVT_ER_EM_MOV ");
