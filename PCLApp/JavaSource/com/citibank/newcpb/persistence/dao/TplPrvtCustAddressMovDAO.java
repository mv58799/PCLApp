...
public class TplPrvtCustAddressMovDAO extends BaseOracleDAO {
	...
	public void deleteByGFCID(String custGfcidNbr) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_ADDRESS_MOV WHERE CUST_GFCID_NBR = ? ");
	...
	public void deleteByKey(Long custGfcidNbr, Integer addrSeqNbr, String addrTypeCode) {
		...
		try {
			...
			query.append(" DELETE FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_ADDRESS_MOV WHERE CUST_GFCID_NBR = ? AND ADDR_SEQ_NBR = ? AND ADDR_TYPE_CODE = ? ");
	...
	public AddressVO insert(AddressVO vo) {
		...
		System.out.println("" + vo.getAddrTypeCode() + "INICIO TPL_PRVT_CUST_ADDRESS_MOV");
		...
		try {
			...
			sqlQuery.append("INSERT INTO " + C_PL_SCHEMA + "TPL_PRVT_CUST_ADDRESS_MOV ( ");
			...
			System.out.println("" + vo.getCustGfcidNbr() + " / "  + vo.getAddrSeqNbr() + " / "  + vo.getAddrTypeCode());

			if (vo.getCustGfcidNbr() != null) {
				preparedStatement.setLong(count++, vo.getCustGfcidNbr());
			} else {
				System.out.println("ERRO: Campo vo.getCustGfcidNbr() null ");
				throw new UnexpectedException(C_ERROR_EXECUTING_STATEMENT, null);
			}
			...
			if (vo.getAddrSeqNbr() != null) {
				...
				System.out.println("ERRO: Campo vo.getAddrSeqNbr() null ");
				throw new UnexpectedException(C_ERROR_EXECUTING_STATEMENT, null);
			}
			...
			if (!StringUtils.isBlank(vo.getAddrTypeCode())) {
				...
				System.out.println("ERRO: Campo vo.getAddrTypeCode() null ");
				throw new UnexpectedException(C_ERROR_EXECUTING_STATEMENT, null);
			}
		...
		System.out.println("" + vo.getAddrTypeCode() + "FIM TPL_PRVT_CUST_ADDRESS_MOV");
		return vo;
	}
	...
	public ArrayList<AddressVO> list(String custGfcidNbr){
		...
		try {
			...
			sqlQuery.append("    LAST_UPD_DATE, ");
			sqlQuery.append("    LAST_UPD_USER ");	
			sqlQuery.append(" FROM " + C_PL_SCHEMA + "TPL_PRVT_CUST_ADDRESS_MOV ");
