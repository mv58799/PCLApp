...
public class TplPrvtDmnKeProdDAO extends BaseOracleDAO {
	...
	public ArrayList<QuestionsKeAnswVO> listQuestionsKeDmn(String acctNbr, String cpfCnpj) {
		...
		try {
			...
			+ "   PROD.PROD_KE_CODE, "
			+ "   PROD.PROD_KE_TEXT, "		
			+ "   (select ASNW_CODE FROM " + C_PL_SCHEMA + "  TPL_PRVT_ACCT_KE_ANSW WHERE PROD.PROD_KE_CODE = PROD_KE_CODE AND PROD_FAML.PROD_FAML_KE_CODE = PROD_FAML_KE_CODE  AND  ACCT_NBR = ' " + acctNbr + "' AND  CUST_CPF_CNPJ_NBR = ' " + cpfCnpj + "' AND QUEST_TYPE_CODE = '" + QuestKeTypeEnum.PROD.getValue() + "') AS ASNW_CODE_PROD, "
			+ "   (select ASNW_CODE FROM " + C_PL_SCHEMA + "  TPL_PRVT_ACCT_KE_ANSW WHERE PROD.PROD_KE_CODE = PROD_KE_CODE AND PROD_FAML.PROD_FAML_KE_CODE = PROD_FAML_KE_CODE  AND ACCT_NBR = ' " + acctNbr + "' AND  CUST_CPF_CNPJ_NBR = ' " + cpfCnpj + "' AND QUEST_TYPE_CODE = '" + QuestKeTypeEnum.FMA.getValue() + "') AS ASNW_CODE_FMA, "
			+ "   (select ASNW_CODE FROM " + C_PL_SCHEMA + "  TPL_PRVT_ACCT_KE_ANSW WHERE PROD.PROD_KE_CODE = PROD_KE_CODE AND PROD_FAML.PROD_FAML_KE_CODE = PROD_FAML_KE_CODE AND ACCT_NBR = ' " + acctNbr + "' AND  CUST_CPF_CNPJ_NBR = ' " + cpfCnpj + "' AND QUEST_TYPE_CODE = '" + QuestKeTypeEnum.VMA.getValue() + "') AS ASNW_CODE_VMA "
