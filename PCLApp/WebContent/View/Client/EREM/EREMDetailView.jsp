...
<html:html>
	...
	<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>
		...
		<TITLE>Detalhe de Associação ER x EM </TITLE>
	</HEAD>

	<body>
		<html:form action="/EREM.EREMDetail.Consult.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="CustomerSheet"/>
				<jsp:param name="currentSubSheet" value="Clientes" />
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>	
			<html:text property="backURL" value="EREM.EREMDetail.Consult.Show" style="display:none"></html:text>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Associação ER x EM</th>
								</tr>
							</thead>
							<tr>
								<td>
						...
						<table class="ODS_internalWidth" border="0">
							...
							<tr>
								...
								<table class="ODS_internalWidth" border="0">
									<tbody>
										<tr class="fixed">
											<TH class="ODS_header" width="7%">Número do ER</TH>
											<TH class="ODS_header" width="7%">Número do EM</TH>
											<TH class="ODS_header" width="16%">Papel do Cliente no Relacionamento</TH>
										...
										<logic:notEmpty name="EREMDetailForm"	property="erEmGrid">
											<logic:iterate name="EREMDetailForm"
												...
												<td align="right" width="7%"><%=resultLine[EREMDetailForm.COL_POS_ER_NBR]%></td>
												<td align="right" width="7%"><%=resultLine[EREMDetailForm.COL_POS_EM_NBR]%></td>
												<td align="left" width="16%"><%=resultLine[EREMDetailForm.COL_POS_ROLE_CUST_CODE]%></td>
												<td align="left" width="20%"><%=resultLine[EREMDetailForm.COL_POS_CUST_FULL_NAME]%></td>											
												</tr>
											</logic:iterate>
										</logic:notEmpty>
									</tbody>
