...
<html:html>
	...
	<script language="javascript">
		function extraActions( action )
		{
			if ( action == 'insertDomain' ) {
				document.forms[0].action = "EREM.EREMDetail.Update.InsertDomain"; 
				document.forms[0].backURL.disabled = true; 
			}
			else if ( action == 'deleteDomain' ) {
				document.forms[0].action = "EREM.EREMDetail.Update.DeleteDomain"; 
				document.forms[0].backURL.disabled = true; 
			}
	...
	<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>
		...
		<TITLE>Alteração de Associação ER x EM</TITLE>
	</HEAD>

	<body>
		<html:form action="/EREM.EREMDetail.Update.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="CustomerSheet"/>
				<jsp:param name="currentSubSheet" value="Clientes" />
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>	
			<html:text property="backURL" value="EREM.EREMDetail.Update.Show" style="display:none"></html:text>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead><tr><th class="subtitle" scope="colgroup" colspan="4">Alteração de Associação ER x EM</th></tr></thead>
							<tbody>
								<tr class="ODS_Detail_Line1">
									<TD colspan="4">Número do ER</TD>
								</tr>
								<tr class="ODS_Detail_Line2">
									<TD colspan="4"><html:text property="erNbr" styleClass="ODS_Text_Field_Size_30" disabled="true"></html:text></TD>
								</tr>

								<tr><td width="100%">&nbsp;</td></tr>
								<tr class="ODS_line11"><td colspan="4">Dados do EM:</td></tr>
								<tr><td colspan="4"><img src='<%= request.getContextPath() %>/Common/image/20grey1.gif' width="100%" height="1"></td></tr>
								<tr><td width="100%">&nbsp;</td></tr>

								<tr class="ODS_Detail_Line1">
									<TD width="25%">Papel do Cliente no Relacionamento *</TD>											
								...
								<tr class="ODS_Detail_Line2">
									<TD width="25%"><html:text property="custNbr" styleClass="ODS_Text_Field_Size_15" maxlength="11" onkeyup="MaskFieldPress('CHAR','NNNNNNNNNNN','left',null)"></html:text>&nbsp;&nbsp;<html:button property="getBtn" value="Buscar" onclick="enableFields();submitAction('PreparedSearch.CustomerPrvt.CustomerPrvtList.Update');"></html:button></TD>
							...
							<thead><tr><th class="subtitle" scope="colgroup" colspan="6">EM's Associados</th></tr></thead>
								<tbody>
									...
									<logic:notEmpty name="EREMDetailForm"	property="erEmGrid">
										<logic:iterate name="EREMDetailForm" property="erEmGrid" indexId="index" id="row">
