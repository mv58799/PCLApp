...
<html:html>
	...
	<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>
		...
		<TITLE>Alteração de Dados Complementares de ER com Pendência de Aprovação</TITLE>
	</HEAD>
	...
	<body>
		<html:form action="/ER.ERMovementDetail.Update.Show.do">
			...
			<html:text property="backURL" value="ER.ERMovementDetail.Update.Show" style="display:none"></html:text>
			<table class="ODS_mainTable" cellspacing="0">
				<tr>
					<td>&nbsp;</td>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead><tr><th class="subtitle" scope="colgroup" colspan="4">Alteração de Dados Complementares de ER com Pendência de Aprovação</th></tr></thead>
								<tbody>
									...
									<tr class="ODS_Detail_Line2">
										<TD width="40%"><html:text property="erNbr" styleClass="ODS_Text_Field_Size_30" maxlength="30" disabled="true"></html:text></TD>
										<TD width="60%">
