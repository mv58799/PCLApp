	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr height="40">
						<th class="subtitle" scope="colgroup" colspan="3">Inserção de Contato</th>
					</tr>
				</thead>
				<tr>
					<td>&nbsp;</td>
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<td width="100%">&nbsp;</td>
								<TD width="100%"><html:button property="insertBtn" value="Confirmar Inserção" onclick="submitAction('insert');"></html:button></TD>
