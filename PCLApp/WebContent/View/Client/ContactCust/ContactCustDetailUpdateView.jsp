...
<body>
<html:form action="/ContactCust.ContactCustDetail.Update.Show.do">
	...
	<html:text property="backURL" value="ContactCust.ContactCustDetail.Update.Show"	style="display:none"></html:text>
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr height="40">
						<th class="subtitle" scope="colgroup" colspan="3">Alteração de Contato</th>
					</tr>
				</thead>
				<tr>
					<td>&nbsp;</td>
					...
					<table class="ODS_internalWidth" border="0" cellspacing="0">
						<tbody>
							...
							<tr class="ODS_Detail_line2">
								<td width="15%"><html:text property="ctcNbr" styleClass="ODS_Text_Field_Size_5" disabled="true" maxlength="6"></html:text></td>
								<td width="15%"></td>
								...
								<td colspan="4">
									<TABLE class="ODS_internalWidth" border="0">
										<tbody>
											...
											<TD width="12%"><html:text property="phoneNbr" maxlength="10" styleClass="ODS_Text_Field_Size_10" onkeyup="MaskFieldPress('CHAR','NNNNNNNNNN','left',null)"></html:text></TD>
											<TD width="12%"><html:text property="phoneExtnNbr" maxlength="5" styleClass="ODS_Text_Field_Size_5" onkeyup="MaskFieldPress('CHAR','NNNNN','left',null)"></html:text></TD>	
											<TD width="100%"></TD>			
										</TR>
										</tbody>
									</TABLE></TD>
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<td width="100%">&nbsp;</td>
								<TD width="100%"><html:button property="updateBtn" value="Confirmar Alteração" onclick="submitAction('update');"></html:button></TD>
