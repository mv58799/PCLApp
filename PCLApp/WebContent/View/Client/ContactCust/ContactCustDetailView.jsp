...
<TITLE>Detalhe do Contato</TITLE>
</HEAD>
<body>
<html:form action="/ContactCust.ContactCustDetail.Consult.Show.do">
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr height="40">
						<th class="subtitle" scope="colgroup" colspan="3">Detalhe do Contato</th>
					</tr>
				</thead>
				<tr>
					<td>&nbsp;</td>
								...
								<td colspan="4">
									<TABLE class="ODS_internalWidth" border="0">
										<tbody>
											...
											<TD width="18%"><html:text  property="phoneNbr" maxlength="10" styleClass="ODS_Text_Field_Size_10" disabled="true" ></html:text></TD>
											<TD width="10%"><html:text  property="phoneExtnNbr" maxlength="5" styleClass="ODS_Text_Field_Size_5" disabled="true" ></html:text></TD>	
											<TD width="100%"></TD>			
										</TR>
										</tbody>
									</TABLE></TD>
