...
<html:html>
	...
	<script language="javascript">
		...
		<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
			<jsp:param name="pageName" value="CustomerBroker.CustomerBrokerDetail"/>
	...
	<body>
		<html:form action="/CustomerBroker.CustomerBrokerDetail.Consult.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="ProductSheet"/>
				<jsp:param name="currentSubSheet" value="Broker"/>
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="CustomerBroker.CustomerBrokerList.List.Show" style="display:none"></html:text> 
							...
							<tr>
								...
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											<TD colspan="1" width="24%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrApprvStatCode" maxlength="10" disabled="true"></html:text></TD>
										...
										<tr class="ODS_Detail_Line1">
											<TD colspan="1">Data/Hora Última Atualização</TD>
											<td colspan="2">Código Usuário Última Alteração</td>
											<TD colspan="2">Data/Hora Aprovação</TD>
										</tr>
										<tr class="ODS_Detail_Line2">
											<TD colspan="1"><html:text styleClass="ODS_Text_Field_Size_10" property="lastUpdDate" maxlength="10" disabled="true"></html:text></TD>
											<td colspan="2"><html:text styleClass="ODS_Text_Field_Size_20" property="lastUpdUserId" maxlength="20" disabled="true"></html:text></td>
											<TD colspan="2"><html:text styleClass="ODS_Text_Field_Size_10" property="lastAuthDate" maxlength="10" disabled="true"></html:text></TD>
										</tr>


										<tr class="ODS_Detail_Line1">							
											<td colspan="6">Código Usuário Aprovação</td>
										</tr>
										<tr class="ODS_Detail_Line2">											
											<td colspan="6"><html:text styleClass="ODS_Text_Field_Size_20" property="lastAuthUserId" maxlength="20" disabled="true"></html:text></td>
										</tr>
										...
										<table class="ODS_internalWidth" border="0">
											<thead>
												<tr>
													<th class="subtitle" scope="colgroup" colspan="3">Clientes Associados</th>
												</tr>
											</thead>
											<tr>
												<td>
												<table class="ODS_internalWidth" border="0">
													<tbody>
														<tr class="fixed">
															<TH class="ODS_header" width="15%">No. do Cliente</TH>
															<TH class="ODS_header" width="15%">Nome do Cliente</TH>
															<TH class="ODS_header" width="15%">No. do Cliente na Corretora</TH>
														</tr>				
													</tbody>
												</TABLE>
											</tr>
