...
<script language="javascript">
        ...
        function extraActions(action) {
            ...
            if (action == 'insertDocTransfer') {
                document.forms[0].action = "IpDocPrvt.IpDocPrvtDetail.Insert.InsertDocTransfer";
                document.forms[0].backURL.disabled = true;
            }
            else if (action == 'insertCallback') {
                document.forms[0].action = "IpDocPrvt.IpDocPrvtDetail.Insert.InsertCallback";
                document.forms[0].backURL.disabled = true;
            }
            else if (action == 'deleteDocTransfer') {
                document.forms[0].action = "IpDocPrvt.IpDocPrvtDetail.Insert.DeleteDocTransfer";
                document.forms[0].backURL.disabled = true;
            }
            else if (action == 'deleteCallback') {
                document.forms[0].action = "IpDocPrvt.IpDocPrvtDetail.Insert.DeleteCallback";
                document.forms[0].backURL.disabled = true;
            }
		...
		function showErrorMessage(){
			if (!verifyCallBackSelected() ||!verifyDocTransferSelected() ){
				...
				validationMessageArea.innerHTML += 'Erro: O registro não pode ser inserido pois são obrigatórias uma ou mais associações com "Instrução Permanente".<br>';
...
<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
	...
	<jsp:param name="searchInputFields"
		value="'ctcNbrSrc','curAcctNbrSrc','custNbrSrc'" />
</jsp:include>
<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>
<TITLE>Inserção de Instrução Permanente</TITLE>
</HEAD>

<body>
<html:form action="/IpDocPrvt.IpDocPrvtDetail.Insert.Show.do">
		...
		<tr>
			...
			<table class="ODS_internalWidth" border="0">
				<html:text property="backURL"
					value="IpDocPrvt.IpDocPrvtDetail.Insert.Show" style="display:none"></html:text>
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Inserção de
				...
				<tr>
					...
					<table class="ODS_internalWidth" border="0" cellspacing="0">
						<tbody>							
							<html:hidden property="ipDocCode"></html:hidden>
					...
					<table id="gridTable" class="ODS_internalWidth" border="0">
						<tbody>
							<tr id="gridHeader" class="fixed">
								<TH class="ODS_header" width="5%">Inserir</TH>
								<TH class="ODS_header" width="5%">Excluir</TH>
								...
								<logic:iterate name="IpDocPrvtDetailForm"
									...
									<td width="5%" align="center"><input type="checkbox"
										...
										class="checkbox" /></td>
									<td width="5%" class="centralized"><%=domainsAgnBankName%></td>
									<td width="5%" class="centralized"><%=domainsBrchName%></td>
									<td width="10%" class="centralized"><%=domainsCurAcctCode%></td>
									<td width="10%" class="centralized"><%=domainsBeneCpfCnpjNbr%></td>
									<td width="30%" class="centralized"><%=domainsBeneNameText%></td>
					...
					<table class="ODS_internalWidth" border="0" cellspacing="0">
						<tbody>							
							...
							<tr class="ODS_Detail_Line1">
								...
								<td width="25%"><html:text property="phoneExtnNbr" maxlength="5"
									styleClass="ODS_Text_Field_Size_5"
					...
					<table id="gridTable" class="ODS_internalWidth" border="0">
						<tbody>
							...
							<logic:iterate name="IpDocPrvtDetailForm"
								...
								<td width="25%" class="centralized"><%=domainsFullNameText%></td>
								<td width="25%" class="centralized"><%=fullNameText_2%></td>
								<td width="25%" class="centralized"><%=fullNameText_3%></td>
				...
				<tr>
					...
					<table class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<TD width="100%"></TD>
								<TD><html:button property="insertBtn" value="Confirmar Inserção"
									onclick="javascript:document.forms[0].actionPerformed.value='insertIpDocPrvt';submitAction('insert');"></html:button></TD>
