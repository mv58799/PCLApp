...
<TITLE>Detalhe de Histórico de Instrução Permanente</TITLE>
</HEAD>
<body>
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr >
						<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Histórico de Instrução Permanente</th>
					</tr>
				</thead>
				<tr>
					<td>
					<table class="ODS_internalWidth" border="0" cellspacing="0">
						<tbody>
							...
							<tr class="ODS_Detail_line1">
								<td width="30%">Data de Referência</td>
								<TD width="35%" colspan="3">Usuário da Última Atualização</TD>
							</tr>
							<tr class="ODS_Detail_line2">
							...
							<tr class="ODS_Detail_line1">
								...
								<td width="35%">Usuário da Última Autorização</td>
								<TD width="35%" colspan="2">Data/Hora da Última Autorização</TD>
							</tr>
