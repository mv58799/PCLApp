...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<TITLE>Exclusão de Associação Conta Corrente X Instrução Permanente</TITLE>

	</HEAD>

	<body>
		<html:form action="/CurAcctPrmntInstr.CurAcctPrmntInstrDetail.Delete.Show.do">
			...
			<table class="ODS_mainTable" cellspacing="0">
				<tr>
					<td>&nbsp;</td>
					<html:text property="backURL" value="CurAcctPrmntInstr.CurAcctPrmntInstrDetail.Delete.Show" style="display:none"></html:text>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr><th class="subtitle" scope="colgroup" colspan="2">Exclusão de Associação Conta Corrente X Instrução Permanente</th></tr>
							</thead>
							<tr>
								<td>
