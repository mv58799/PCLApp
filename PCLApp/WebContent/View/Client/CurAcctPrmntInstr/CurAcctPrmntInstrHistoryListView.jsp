...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<TITLE>Consulta de Histórico de Associação Conta Corrente X Instrução Permanente</TITLE>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr><th class="subtitle" scope="colgroup" colspan="5">Consulta de Histórico de Associação Conta Corrente X Instrução Permanente</th></tr>
							</thead>
							<tr>
								<td>
									<table class="ODS_internalWidth" border="0" cellspacing="0">
										<tbody>
											...
											<tr class="ODS_line11" height="25"><td colspan="5">Instrução Permanente:</td></tr>
											<tr>
						 						<td colspan="5"><img src='<%= request.getContextPath() %>/Common/image/20grey1.gif' height="1" width="100%"></td>
											</tr>
												...
												<td colspan="5">
													<TABLE>
														<tr>
															...
															<TD width="18%" align="right">&nbsp;Data de Referência</TD>
												...
												<td width="100%">
													<table id="gridTable" class="ODS_internalWidth" border="0">
														...
														<tr class="fixed" id="gridHeader">
															...
															<TH class="ODS_header" width="10%">Número do Cliente</TH>
