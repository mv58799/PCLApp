...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<TITLE>Consulta de Associação Conta Corrente X Instrução Permanente com Pendência de Aprovação</TITLE>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr><th class="subtitle" scope="colgroup" colspan="3">Consulta de Associação Conta Corrente X Instrução Permanente com Pendência de Aprovação</th></tr>
							</thead>
							<tr>
								<td>
