...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<TITLE>Detalhe de Histórico de Associação Conta Corrente X Instrução Permanente</TITLE>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr><th class="subtitle" scope="colgroup" colspan="2">Detalhe de Histórico de Associação Conta Corrente X Instrução Permanente</th></tr>
							</thead>
							<tr>
								<td>
												...
												<td width="100%">
													<table>
														<tr class="ODS_Detail_Line1">
															...
															<td width="25%">&nbsp;Data/Hora Última Atualização</td>
															<td width="25%">&nbsp;Usuário de Autorização</TD>
															<td width="25%">Data/Hora da Autorização</TD>
														</tr>
													</table>
												</td>
											</tr>
