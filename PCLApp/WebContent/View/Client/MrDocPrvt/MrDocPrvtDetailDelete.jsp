...
<TITLE>Exclusão de Memo de Risco</TITLE>
</HEAD>
<body>

<html:form action="/MrDocPrvt.MrDocPrvtDetail.Delete.Show.do">
	...
	<table class="ODS_mainTable" cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr>
			<html:text property="backURL" value="MrDocPrvt.MrDocPrvtDetail.Delete.Show" style="display:none"></html:text>
			<td >
			<table class="ODS_internalWidth" border="0">
				<thead><tr><th class="subtitle" scope="colgroup" colspan="6" height="52">Exclusão de Memo de Risco</th><tr></thead>
				<tr>
					<td>					
					<tr>
						<td>
						...
						<table class="ODS_internalWidth" border="0">
							<thead><tr><th class="subtitle" scope="colgroup" colspan="6">Dados de Callback</th></tr></thead>
							<tr>
								<td width="100%">
