...
<TITLE>Exclusão de Cliente - Dados Complementares</TITLE>
</HEAD>

<body>
<html:form
	action="/CustomerPrvtCmpl.CustomerPrvtCmplDetail.Delete.Show.do">
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<td><html:text property="backURL"
				value="CustomerPrvtCmpl.CustomerPrvtCmplDetail.Delete.Show"
				style="display:none"></html:text>
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Exclusão de Cliente - Dados Complementares</th>
					</tr>
				</thead>
				<tr>
					<td>
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<TD width="100%">&nbsp;</TD>
								<TD width="100%"><html:button property="excluir" value="Confirmar Exclusão" onclick="submitAction('delete');"></html:button></TD>
