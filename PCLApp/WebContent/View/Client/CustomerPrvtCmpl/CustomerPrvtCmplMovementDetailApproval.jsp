...
<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
	<jsp:param name="pageName" value="CustomerPrvtCmpl.CustomerPrvtCmplMovementDetail" />
	<jsp:param name="approvalControlNames" value="'approveBtn','',''"/>
</jsp:include>
<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>

<TITLE>Detalhe de Cliente com Pendência de Aprovação - Dados Complementares</TITLE>
</HEAD>

<body>
<html:form
	action="/CustomerPrvtCmpl.CustomerPrvtCmplMovementDetail.Approval.Show.do">
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<td><html:text property="backURL"
				value="CustomerPrvtCmpl.CustomerPrvtCmplMovementDetail.Consult.Show"
				style="display:none"></html:text>
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Cliente com Pendência de Aprovação- Dados Complementares</th>
					</tr>
				</thead>
				<tr>
					<td>
					<table class="ODS_internalWidth" border="0" cellspacing="0">
						<tbody>
							...
							<tr class="ODS_Detail_Line2">
								<td width="16%" colspan = "2"><html:text styleClass="ODS_Text_Field_Size_10" property="prvtCustNbr"
									disabled="true"></html:text></td>
							</tr>
							<tr class="ODS_Detail_Line1">
								<td colspan="6">
									...
									<table>
										...
										<tr>
											...
											<TD width="59%"><html:text styleClass="ODS_Text_Field_Size_40"
												property="offcrText" disabled="true" size="60"></html:text></TD>
							...
							<tr class="ODS_Detail_Line1">
								<TD width="16%">Operação</TD>
								<td width="2%"></td>
								<TD width="16%" colspan = "2">Data/Hora Última Atualização</TD>
								<TD width="16%" colspan = "2">Usuário Última Atualização</TD>
								
							</tr>
							<tr class="ODS_Detail_Line2">
								<TD width="16%"><html:text property="opernCode" disabled="true" styleClass="ODS_Select_Field_Size_10"></html:text></TD>
								<td width="2%"></td>
								<TD width="16%" colspan = "2"><html:text property="lastUpdDate" disabled="true" styleClass="ODS_Select_Field_Size_20"></html:text></TD>
															
								<TD width="16%" colspan = "2"><html:text property="lastUpdUserId" disabled="true" styleClass="ODS_Select_Field_Size_20"></html:text></TD>
							...
							<tr class="ODS_Detail_line2">
							    <td width="8%">
						                <html:select property="prvtCustTypeCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							            <html:option value=""></html:option>
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<TD width="100%">&nbsp;</TD>
								<TD width="100%"><html:button property="approveBtn" value="Aprovar"
									onclick="submitAction('approve');"></html:button></TD>
								<TD width="100%"><html:button property="reproveBtn"
									value="Reprovar" onclick="submitAction('reprove');"></html:button></TD>
								<TD width="100%"><TD><html:button property="backBtn" value="Voltar" onclick="submitAction('back');"></html:button></TD>						
							</TR>
						</TBODY>
					</TABLE>
...
<script language="javascript">
	disableApproveButtons("<bean:write name='CustomerPrvtCmplMovementDetailForm' property='lastUpdUserId'/>","<bean:write name='CustomerPrvtCmplMovementDetailForm' property='opernCode'/>",'true');							
</script>