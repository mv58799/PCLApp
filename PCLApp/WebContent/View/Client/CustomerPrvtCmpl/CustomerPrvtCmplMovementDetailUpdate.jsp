...
<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
	...
	<jsp:param name="inputSearchFields" value="'offcrNbrSrc','custNbrSrc';" />
</jsp:include>
<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>

<TITLE>Alteração de Cliente com Pendência - Dados Complementares</TITLE>
</HEAD>
<body>
<html:form action="/CustomerPrvtCmpl.CustomerPrvtCmplMovementDetail.Update.Show.do">
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<td><html:text property="backURL"
				value="CustomerPrvtCmpl.CustomerPrvtCmplMovementDetail.Update.Show"
				style="display:none"></html:text>
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Alteração de Cliente com Pendência - Dados Complementares</th>
					</tr>
				...
				<tr>
					...
					<table class="ODS_internalWidth" border="0">
						<tbody>
							...
							<tr class="ODS_Detail_Line2">
								...
								<td width="2%"></td>
								<TD colspan="4"><html:text styleClass="ODS_Text_Field_Size_60" property="custText" disabled="true"></html:text>									
								</TD>
							...
							<tr class="ODS_Detail_Line2">
								<td colspan = "2"><html:text styleClass="ODS_Text_Field_Size_10" property="prvtCustNbr" disabled="false"></html:text></td>
							</tr>
							<tr class="ODS_Detail_Line1">
								<td colspan="6">
									<table width="100%">
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<TD width="100%">&nbsp;</TD>
								<TD width="100%"><html:button property="alterBtn" value="Alterar" onclick="submitAction('update');"></html:button></TD>
