...
<TITLE>Inserção de Cliente - Dados Complementares</TITLE>
</HEAD>

<body>
<html:form
	action="/CustomerPrvtCmpl.CustomerPrvtCmplDetail.Insert.Show.do">
	...
	<html:hidden property="offcrClear"/>
	...
	<table class="ODS_mainTable" cellspacing="0">
		<tr>
			...
			<td><html:text property="backURL"
				value="CustomerPrvtCmpl.CustomerPrvtCmplDetail.Insert.Show"
				style="display:none"></html:text>
			<table class="ODS_internalWidth" border="0">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Inserção / Alteração de Cliente - Dados Complementares</th>
					</tr>
				</thead>
				<tr>
					<td>
						...
						<tbody>
							...
							<tr class="ODS_Detail_Line1">
								...
								<td colspan="4" rowspan="2">
									...
									<tr>
										<TD width="50%"><html:text styleClass="ODS_Text_Field_Size_10" property="prvtKeyNbr" disabled="false"></html:text></TD>
										<td><html:text styleClass="ODS_Text_Field_Size_30" property="emNbr" maxlength="20"></html:text></td>
									</tr></table>
								</td>

							</tr>
							<tr class="ODS_Detail_Line2">
								<td><html:text styleClass="ODS_Text_Field_Size_10"
									property="prvtCustNbr" disabled="false"></html:text></td>
							</tr>
							<tr class="ODS_Detail_Line1">
								<td colspan="6">
									<table width="100%">
									...
									<table>
										...
										<tr>
											...
											<TD width="59%"><html:text styleClass="ODS_Text_Field_Size_40"
												...
												<html:button property="getOFFCR_NBR" value="Buscar"	onclick="submitAction('PreparedSearch.Officer.OfficerList.Insert');"></html:button>
											</TD>
							...
							<tr class="ODS_Detail_Line1">
								<td colspan="6">
										...
										<tr>
								           ...
								           <tr class="ODS_Detail_line2">
									    	<td width="8%">
						                      <html:select property="prvtCustTypeCode" styleClass="ODS_Select_Field_Size_20">
										      <html:option value=""></html:option>
					...
					<TABLE class="ODS_internalWidth" border="0">
						<TBODY>
							<TR>
								<TD width="100%"></TD>
								<TD><html:button property="inserir" value="Confirmar Alteração" onclick="javascript:document.forms[0].offcrNbrSrc.disabled = true; submitAction('insert');"></html:button></TD>
								<TD><html:button property="limpar" value="Limpar" onclick="clearCustPage()"></html:button></TD>	
