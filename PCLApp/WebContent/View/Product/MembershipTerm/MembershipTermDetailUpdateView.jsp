...
<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
	...
	<jsp:param name="controlNames" value="'adicionarProdutoTermoBtn', 'removerProdutoTermoBtn', 'updateBtn', 'deleteBtn', 'clearBtn'" />
			...
			<tr>
				<td>
					<table class="ODS_internalWidth" border="0">
						<thead>
							<tr>
								<th class="subtitle" scope="colgroup">Alterar Termo de adesão</th>
							</tr>
												...
												<td>
													<table class="ODS_internalWidth" border="0">
														<tbody>
															...
															<tr class="ODS_Detail_Line1">
																<td>&nbsp;</td>
																<td><html:button property="addTermAdhesionBtn" value="Adicionar" onclick="javascript:adicionarProdutoTermo();"/>&nbsp;
																	<html:button property="removeTermAdhesionBtn" value="Remover" onclick="javascript:removerProdutoTermo();"/></td>
															</tr>
														</tbody>
													</table>
												</td>
					...
					<table class="ODS_internalWidth" border="0">
						<tbody>
							<tr>
								<td width="100%"></td>
								<td><html:button property="updateBtn" value="Confirmar" onclick="javascript:atualizarArrayProdutoTermo();submitAction('update', true);"></html:button></td>
								<td><html:button property="deleteBtn" value="Excluir" onclick="javascript:atualizarArrayProdutoTermo();submitAction('delete', true);"></html:button></td>
