...
<html:html>
	...
	<script language="javascript">
		...
		<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
			<jsp:param name="pageName" value="ProdPlayerRole.ProdPlayerRoleMovementList"/>
		...
		<TITLE> Consulta de Associação de Player x Produtos com Pendência de Aprovação </TITLE>
	</HEAD>

	<body>
		<html:form action="/ProdPlayerRole.ProdPlayerRoleMovementList.List.Show.do">
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Consulta de Associação de Player x Produtos com Pendência de Aprovação</th>
								</tr>
							</thead>
							<tr>
								<td>
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<TR class="ODS_Detail_Line2" height="30">
											<TD width="14%">Seg. do Sistema</TD>
											<TD width="15%"><html:text styleClass="ODS_Text_Field_Size_15" property="sysSegCodeSrc" maxlength="2" onkeyup="MaskFieldPress('CHAR','NN','left',null)"></html:text></TD>
											<td colspan="4">&nbsp;&nbsp;Usuário de Última Atualização&nbsp;&nbsp;
												<html:text styleClass="ODS_Text_Field_Size_15" property="lastUpdUserIdSrc" maxlength="20"></html:text>
											</td>
										</TR>
									</tbody>
								</TABLE>
								...
								<table class="ODS_internalWidth" border="0">
									<tbody>
										<TR class="fixed">
											...
											<TD align="right"><html:button property="alterBtn" value="Alterar" onclick="submitAction('update');" disabled="true"></html:button></TD>
								...
								<table id="gridTable" class="ODS_internalWidth" border="0">
									<tbody>
										<tr id="gridHeader" class="fixed">
											...
											<TH class="ODS_header" width="30%">Nome do Player</TH>
											<TH class="ODS_header" width="20%">CNPJ do Player</TH>
											<TH class="ODS_header" width="20%">Quantidade Produto</TH>
											<TH class="ODS_header" width="20%">Usuário de Última Atualização</TH>
										</tr>	
										<ods:DataSetRows name="ProdPlayerRoleMovementListForm" property="results" dataSetRowName="resultRow" stepIndexName="step" sequenceRestartStep="2">				
											...
											<bean:define name="resultRow" property="stringByName(LAST_UPD_USER_ID)" id="lastUpdUserIdSrc" type="java.lang.String"></bean:define>
	 											<TD width="2%"><input type="radio" class="radio" name="selection" onclick="javascript:selectedPlyrCnpjNbr.value='<%= selectedPlyrCnpjNbr %>'; disableButtons(false);disableApproveButtons('<%= lastUpdUserIdSrc %>','',true);"/></td>
												<TD width="30%"><a class="ODS_CursorHand" href="#" onclick="javascript:selectedPlyrCnpjNbr.value='<%= selectedPlyrCnpjNbr %>'; disableButtons(false);submitAction('approve');"><bean:write name="resultRow" property="stringByName(PLYR_NAME)"/></a></td>
												<TD width="20%" align="right"><bean:write name="resultRow" property="stringByName(PLYR_CNPJ_NBR)"/></td>
												<TD width="20%" align="center"><bean:write name="resultRow" property="stringByName(QTDE_PROD)"/></td>
												<TD width="20%" align="center"><bean:write name="resultRow" property="stringByName(LAST_UPD_USER_ID)"/></td>
