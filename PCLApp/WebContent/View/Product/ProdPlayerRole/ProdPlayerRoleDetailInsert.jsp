...
<html:html>
	...
	<script language="javascript">
		...
		function extraActions( action )
		{
			if ( action == 'insertDomain' ) {
				document.forms[0].action = "ProdPlayerRole.ProdPlayerRoleDetail.Insert.InsertDomain"; 
				document.forms[0].backURL.disabled = false; 
			}
			else if ( action == 'deleteDomain' ) {
				document.forms[0].action = "ProdPlayerRole.ProdPlayerRoleDetail.Insert.DeleteDomain"; 
				document.forms[0].backURL.disabled = false; 
			}
			else if ( action == 'Product.ProductList' ) {
				document.forms[0].action = "ProdPlayerRole.ProdPlayerRoleDetail.Insert.ListProduct"; 
				document.forms[0].backURL.disabled = false; 
			}

			else if ( action == 'clearPage' ) {
				document.forms[0].action = "ProdPlayerRole.ProdPlayerRoleDetail.Insert.ClearPage"; 
				document.forms[0].backURL.disabled = false; 
			}
		};
	...
	function showErrorMessage(){
		if (!verifyItemsSelected()){
			...
			validationMessageArea.innerHTML += 'Erro: O registro não pode ser inserido pois são obrigatórias uma ou mais associações com "Player".<br>';
	...
	<TITLE>Associação Player x Produto</TITLE>
	</HEAD>
	<body>
		<html:form action="/ProdPlayerRole.ProdPlayerRoleDetail.Insert.Show.do">
			...
			<html:text property="backURL" value="ProdPlayerRole.ProdPlayerRoleDetail.Insert.Show" style="display:none"></html:text>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead><tr><th class="subtitle" scope="colgroup" colspan="3">Associação de Player x Produto</th></tr></thead>
								<tbody>
									...
									<tr><td colspan="3" width="100%"><img src='<%= request.getContextPath() %>/Common/image/20grey1.gif' width="100%" height="1"></td></tr>
										...
										<tr>
					 						<td colspan="3" width="100%"><img src='<%= request.getContextPath() %>/Common/image/20grey1.gif' width="100%" height="1"></td>
										</tr>
										<tr class="ODS_Detail_Line1">
						...
						<tr>
							...
							<TD>
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<thead><tr><th class="subtitle" scope="colgroup" colspan="3">Lista de Produtos</th></tr></thead>
										<tr>
											<td colspan="3">								
												<div class="ODS_DivGridVertical">
													<table class="ODS_internalWidth" border="0">
														<tbody>
															...
															<%int auxIndex = 0;%>
															<logic:notEmpty name="ProdPlayerRoleDetailForm"	property="listProduct">
																<logic:iterate name="ProdPlayerRoleDetailForm"	property="listProduct" indexId="index2" id="row">
																	<%
																		ProdPlayerRoleDetailForm prodPlayerRoleDetailForm = (ProdPlayerRoleDetailForm) session.getAttribute("ProdPlayerRoleDetailForm");
																		String[] resultList = prodPlayerRoleDetailForm.getListProduct()[auxIndex++];
																	%>
																	...
																	<bean:define name="ProdPlayerRoleDetailForm" property='<%="selectedProduct["+index2+"]"%>' id="selectedProduct" type="java.lang.String" />
								...
								<TD>	
									<table class="ODS_internalWidth" border="0">
										<tbody>
											<TR>
												<TD width="100%"></TD>
												<TD align="left"><html:button property="insertProduct" value="Adicionar Produtos" onclick="submitAction('insertDomain');"></html:button></TD>
											</TR>
										</tbody>
									</TABLE>
								</td>
									...
									<table class="ODS_internalWidth" border="0">
										...
										<tbody>
											<tr class="fixed">
												...
												<TH class="ODS_header" width="13%">Código do Produto</TH>
												<TH class="ODS_header" width="12%">Código do Sistema</TH>
											...
											<logic:notEmpty name="ProdPlayerRoleDetailForm"	property="prodPlayerRoleDomains">
												<logic:iterate name="ProdPlayerRoleDetailForm" property="prodPlayerRoleDomains" indexId="index" id="row">
													<%
													...
													<bean:define name="ProdPlayerRoleDetailForm" property='<%="selectedItemsInGrid["+index+"]"%>' id="selectedItemsInGrid" type="java.lang.String" />
													<bean:define name="ProdPlayerRoleDetailForm" property='<%="deletedItems["+index+"]"%>' id="deletedItems" type="java.lang.String" />
