...
<html:html>
	...
	<script language="javascript">
		...
		<TITLE>Detalhe de Associação Player x Produtos</TITLE>
	</HEAD>
	<body>
		<html:form action="/ProdPlayerRole.ProdPlayerRoleDetail.Consult.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="ProductSheet"/>
				<jsp:param name="currentSubSheet" value="Players"/>
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="ProdPlayerRole.ProdPlayerRoleDetail.Consult.Show" style="display:none"></html:text> 
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Associação Player x Produtos</th>
								</tr>
							</thead>
							<tr>
								<td>
