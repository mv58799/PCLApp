...
<html:html>
	...
	<script language="javascript">
		...
		<TITLE> Alteração de Corretoras </TITLE>
	</HEAD>

	<body>
		<html:form action="/Broker.BrokerDetail.Update.Show.do">
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Alteração de Corretora</th>
								</tr>
							</thead>
							<tr>
								<td>
							...
							<tr>
								...
								<table class="ODS_internalWidth" border="0">
									<tbody>
										<TR>
											<TD width="100%">&nbsp;</TD>
											<TD><html:button property="updBtn" value="Alterar" onclick="submitAction('update');"></html:button></TD>
