...
<html:html>
	...
	<body>
		<html:form action="/Broker.BrokerDetail.Delete.Show.do">
				...
				<tr>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Exclusão de Corretora</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
								...
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											...
											<td colspan="2" width="24%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrReqDate" maxlength="12" disabled="true"></html:text></td>
										</tr>									
										...
										<tr class="ODS_Detail_Line2">
											...
											<td colspan="2" width="18%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrApprvDate" maxlength="1" disabled="true"></html:text></td>
											<TD colspan="2" width="24%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrRnwDate" maxlength="12" disabled="true"></html:text></TD>
										</tr>
										...
										<tr class="ODS_Detail_Line2">
											...
											<TD colspan="2" width="18%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrRbtBovespaRate" maxlength="11" disabled="true"></html:text></TD>
											<td colspan="2" width="24%"><html:text styleClass="ODS_Text_Field_Size_10" property="bkrRbtBmfRate" maxlength="11" disabled="true"></html:text></td>
										</tr>
