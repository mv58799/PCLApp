...
<html:html>
	...
	<script language="javascript"> 
		...
		<TITLE> Detalhe de Corretoras com Pendência de Aprovação </TITLE>
	</HEAD>

	<body>
		<html:form action="/Broker.BrokerMovementDetail.Approval.Show.do">
				...
				<tr>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Corretoras com Pendência de Aprovação</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
								...
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											...
											<td colspan="2" width="24%"><html:text styleClass="ODS_Text_Field_Size_20" property="bkrApprvCrLimLcyAmt" maxlength="20" disabled="true"></html:text></td>
										</tr>								
										...
										<tr class="ODS_Detail_Line2">
											<TD colspan="1" width="24%"><html:text styleClass="ODS_Text_Field_Size_20" property="bkrApprvCrLimDlrAmt" maxlength="20" disabled="true"></html:text></TD>
										...
										<tr class="ODS_Detail_Line1">
											<td colspan="1" width="24%">Usuário Última Atualização</td>
											<td colspan="2" width="18%">Data Última Atualização</td>
											<TD colspan="2" width="24%">Ação</TD>
										</tr>
										<tr class="ODS_Detail_Line2">
											<TD colspan="1" width="24%"><html:text styleClass="ODS_Text_Field_Size_20" property="lastUpdUserId" disabled="true"></html:text></TD>
											<td colspan="2" width="18%"><html:text styleClass="ODS_Text_Field_Size_10" property="lastUpdDate" disabled="true"> </html:text></td>
											<td colspan="2" width="18%"><html:text styleClass="ODS_Text_Field_Size_10" property="opernCode" disabled="true"></html:text></td>
										</tr>
...
<script language="javascript">
	disableApproveButtons("<bean:write name='BrokerMovementDetailForm' property='lastUpdUserId'/>","<bean:write name='BrokerMovementDetailForm' property='opernCode'/>",'true');							
</script>
