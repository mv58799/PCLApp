...
<html:html>
	...
	<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
		...
		<TITLE>Alteração de Agregador</TITLE>
	</HEAD>

	<body>
		<html:form action="/AggrProdPrvt.AggrProdPrvtDetail.Update.Show.do">
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Alteração de Agregador</th>
								</tr>
							</thead>
							<tr>
								<td>
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											<TD width="16%"><html:text property="prvtProdAggrCode" disabled="true" styleClass="ODS_Text_Field_Size_10" maxlength="5"></html:text></TD>
