...
<html:html>
	<HEAD>
		...
		<TITLE>Detalhe de Sub-Família com Pendência de Aprovação</TITLE>
	</HEAD>
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Sub-Família com Pendência de Aprovação</th>
								</tr>
							</thead>
							<tr>
								<td>
