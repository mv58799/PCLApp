...
<html:html>
	...
	<script language="javascript">
		...
		function fillTypeRole()
		{
			var check = document.getElementsByName('plyrRoleNames');
			alert(check.value);
		...
		<TITLE>Inserção de Player</TITLE>
	</HEAD>

	<body>
		<html:form action="/Player.PlayerDetail.Insert.Show.do">
				...
				<tr>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Inserção de Player</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
								...
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											<TD colspan="1"><html:text styleClass="ODS_Text_Field_Size_15" property="plyrCnpjNbr" maxlength="18" onkeyup="MaskFieldPress('CHAR','NN.NNN.NNN/NNNN-NN','left',null)"></html:text></TD>
										...
										<tr class="ODS_Detail_Line2">
											...
											<td colspan="1" width="18%"><html:multibox styleClass="checkBox" property="plyrRoleNames" value="CST"></html:multibox>Custodiante</td>
											<td colspan="3" width="18%"><html:multibox styleClass="checkBox" property="plyrRoleNames" value="ISS"></html:multibox>Emissor</td>
										</tr>
										<tr class="ODS_Detail_Line1">
										...
										<tr class="ODS_Detail_Line1">
											<td colspan="4" width="24%">
												<table>													
													...
													<tr>														
														<td><html:text styleClass="ODS_Text_Field_Size_10" property="issueShortNameText" style="text-transform: uppercase"></html:text></td>
										...
										<TR>
											...
											<table class="ODS_internalWidth" border="0" cellspacing="0">
												<tbody>	
													<tr class="ODS_Detail_Line1">		
														<td width="95%">&nbsp;</td>
														<td><html:button property="insertBtn" value="Confirma Inserção" onclick="submitAction('insert',true);"></html:button></td>
