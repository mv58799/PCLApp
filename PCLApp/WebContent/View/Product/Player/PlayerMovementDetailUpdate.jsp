	...
	<script language="javascript">
		function extraActions(action){ 
			if ( action == 'insertIssue' ) {
				document.forms[0].action = "Player.PlayerMovementDetail.Update.InsertIssue"; 
				document.forms[0].backURL.disabled = true; 
			}else if ( action == 'deleteIssue' ) {
				document.forms[0].action = "Player.PlayerMovementDetail.Update.DeleteIssue"; 
				document.forms[0].backURL.disabled = true; 
			}
		}
	</script>
		<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
			...
			<jsp:param name="controlNames" value="'deleteMneBtn'"/>
			<jsp:param name="fieldsWithMask" value="['plyrCnpjNbr','CHAR','NN.NNN.NNN/NNNN-NN','left',null]"/>
		</jsp:include>
		<jsp:include page="/View/Util/JavascriptMasks.jsp" flush="true"></jsp:include>
		<TITLE>Alteração de Player com Pendência de Aprovação</TITLE>
	</HEAD>

	<body>
		<html:form action="/Player.PlayerMovementDetail.Update.Show.do">
				...
				<tr>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Alteração de Player com Pendência de Aprovação</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
								...
								<table class="ODS_internalWidth" border="0" cellspacing="0">
									<tbody>
										...
										<tr class="ODS_Detail_Line2">
											<TD><html:text styleClass="ODS_Text_Field_Size_15" property="plyrCnpjNbr" disabled="true" maxlength="18" onkeyup="MaskFieldPress('CHAR','NNN.NNN.NNN-NN','left',null)"></html:text></TD>
