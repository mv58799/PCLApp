...
<html:html>
	...
	<script language="javascript">
		...
		<TITLE>Exclusão de Player</TITLE>
	</HEAD>
				...
				<tr>
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Exclusão de Player</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
												...
												<table>													
													...
													<tr>
														<td colspan="2" align="right">
															<html:button property="deleteMneBtn" value="Excluir Mnemônico" disabled="true"></html:button>
														</td>
													</tr>
