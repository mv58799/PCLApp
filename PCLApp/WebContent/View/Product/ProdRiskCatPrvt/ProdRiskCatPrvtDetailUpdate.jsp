...
<html:html>
	<HEAD>
		...
		<TITLE>Alteração de Categoria de Risco</TITLE>
	</HEAD>

	<body>
		<html:form action="/ProdRiskCatPrvt.ProdRiskCatPrvtDetail.Update.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp">
				<jsp:param name="currentSheet" value="ProductSheet"/>			
				<jsp:param name="currentSubSheet" value="Parâmetros"/>
			</jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="ProdRiskCatPrvt.ProdRiskCatPrvtDetail.Update.Show" style="display:none"></html:text>
			<table class="ODS_mainTable" cellspacing="0">
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Alteração de Categoria de Risco</th>
								</tr>
							</thead>
							<tr>
								<td>
							...
							<tr>
								...
								<table class="ODS_internalWidth" border="0">
									<TBODY>
										<TR>
											<TD width="100%">&nbsp;</TD>
											<TD><html:button property="alterBtn" value="Confirmar Alteração" onclick="submitAction('update',true);"></html:button></TD>
				...
				<jsp:include page="/View/Util/Footer.jsp"/>
			</table>			
		</html:form>
	</body>
