...
<html:html>
	...
	<body>
		<html:form action="/Product.ProductDetail.Consult.Show.do">
			...
			<html:text property="backURL" value="Product.ProductDetail.Consult.Show" style="display:none"></html:text>
				...
				<tr>
					<td width="100%">
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Detalhe do Produto</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
											...
											<td>
												<table>
													...
													<tr>
														<td>Sub-Familia</td>
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" property="prodSubFamlCode" disabled="true" styleId="prodSubFamlCode" onchange="submitAction('refresh');" >
																<html:option value=""></html:option>
													...
													<tr>
														<td>Qualificação</td>
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" disabled="true" property="prodQlfyCode">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Agregador</td>
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" disabled="true" property="prvtProdAggrCode">
																<html:option value=""></html:option>
													...
													<tr>
														...
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" disabled="true" property="prodRiskCatCode">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Veículo Legal</td>
														<td>
															<html:select property="prodLegalClassCode" disabled="true" styleClass="ODS_Select_Field_Size_20">
														       	 <html:option value=""></html:option>
													...
													<tr>
														<td>Tipo de Ativo</td>
														<td>
															<html:select property="assetTypeCode" disabled="true" styleClass="ODS_Text_Field_Size_70" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td>
										   					<html:select property="assocClassProdCode" disabled="true" styleClass="ODS_Text_Field_Size_70" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td>
										   					<html:select property="prodSentIaInd" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td>
															<html:select property="prodCrTypeClassCode" disabled="true" styleClass="ODS_Select_Field_Size_10">
														       	 <html:option value=""></html:option>
													...
													<tr>
														...
														<td colspan="2">
															<html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodAcctCode" disabled="true" maxlength="15"></html:text>
														</td>
													</tr>
													<tr>
											...
											<td>
												<table>
													<tr>
														...
														<td colspan="3">
															<html:text styleClass="ODS_Text_Field_Size_50" property="prodOrigName" disabled="true" maxlength="50"></html:text>
														</td>
													</tr>
													<tr>
														<td>Data de Aporte</td>
														<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodEvnConTrbDate" disabled="true" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)" ></html:text></td>
														<td>Tipo de abertura</td>
														<td>
															<html:select property="prodOpenTypCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														<td>CNPJ</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodCnpjNbr" maxlength="18" onkeyup="MaskFieldPress('CHAR','NN.NNN.NNN/NNNN-NN','left',null)" ></html:text></td>
														<td>Perfil Fundo</td>
														<td>
															<html:select property="prodFundPrflTyp" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														<td>Conta CBLC</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodBovespaCode" maxlength="20" ></html:text></td>
														<td>ISIN</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodIsinCode" maxlength="20" ></html:text></td>
													</tr>
													<tr>
														<td>Conta BMF</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodBmfCode" maxlength="20" ></html:text></td>
														<td>Código ANBIMA</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodAnbidCode" maxlength="20"></html:text></td>
													</tr>
													<tr>
														<td>Conta Selic</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodSelicCode" maxlength="20"></html:text></td>
														<td>Conta Cetip</td>
														<td><html:text styleClass="ODS_Text_Field_Size_15" disabled="true" property="prodCetipCode" maxlength="20"></html:text></td>
													</tr>
													<tr>
														<td>Data do Evento Abertura</td>
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodOpenEvnDate" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)" ></html:text></td>
														<td>Tipo de encerramento</td>
														<td>
															<html:select property="prodCloseTypCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodAdminRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodAdminRate)" ></html:text>(%)</td>
														<td>Taxa de Performance</td>
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodPerfmRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodPerfmRate)" ></html:text>(%)</td>
													</tr>
													<tr>
														<td>Taxa de ingresso</td>
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodPrtfinvApplRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodPrtfinvApplRate)" ></html:text>(%)</td>
														<td>Taxa de saída</td>
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodExitRate" maxlength="14" onkeyup="NumberFieldPress('3','5','FALSE',prodExitRate)" ></html:text>(%)</td>
													</tr>
													<tr>
														<td>Tipo cota</td>
														<td>
															<html:select property="prodQuotTypeCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
														...
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodCloseTime" maxlength="5" onkeyup="MaskFieldPress('CHAR','NN:NN','left',null)" ></html:text></td>
													</tr>
													<tr>
														<td>Cotização Aplicação D+</td>
														<td><html:text styleClass="ODS_Text_Field_Size_5" disabled="true" property="prodDepQuotDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" ></html:text></td>
														<td>Liquidação de Aplicação D+</td>
														<td><html:text styleClass="ODS_Text_Field_Size_5" disabled="true" property="prodApplLiqDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" ></html:text></td>
													</tr>
													<tr>
														<td>Cotização Resgate D+</td>
														<td><html:text styleClass="ODS_Text_Field_Size_5" disabled="true" property="prodWthdrCrDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" ></html:text></td>
														<td>Liquidação de Resgate D+</td>
														<td><html:text styleClass="ODS_Text_Field_Size_5" disabled="true" property="prodWthdrLiqDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" ></html:text></td>
													</tr>
													<tr>
														<td>Aplicação inicial mínima</td>
														<td><html:text styleClass="ODS_Text_Field_Size_20" disabled="true" property="prodMinStaApplAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMinStaApplAmt)" ></html:text></td>
														<td>Resgate mínimo</td>
														<td><html:text styleClass="ODS_Text_Field_Size_20" disabled="true" property="prodMinWthdrAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMinWthdrAmt)" ></html:text></td>
													</tr>
													<tr>
														<td>Movimentação Mínima</td>
														<td><html:text styleClass="ODS_Text_Field_Size_20" disabled="true" property="prodMovMinAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMovMinAmt)" ></html:text></td>
														<td>Valor Permanência</td>
														<td><html:text styleClass="ODS_Text_Field_Size_20" disabled="true" property="prodHoldMinAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodHoldMinAmt)" ></html:text></td>
													</tr>
													<tr>
														<td>Carência</td>
														<td>
															<html:select property="prodGraceInd" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
										     					<html:option value="S">Sim</html:option>
										     					<html:option value="N">Não	</html:option>
										   					</html:select>
														...
														<td><html:text styleClass="ODS_Text_Field_Size_10" disabled="true" property="prodBalCloseDate" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN','left',null)" ></html:text></td>
													</tr>
													<tr>
														<td>Distribuição CVM</td>
														<td >
															<html:select property="prodCvmDistCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
										   					...
										   					<td>Segmento</td>	
														<td>
															<html:select disabled="true" property="fundDistFormTypeCode">
													...
													<tr>
														<td>Condomínio</td>
														<td >
															<html:select property="prodQuotCndmCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
														...
														<td>
															<html:text disabled="true" property="termText" maxlength="50"></html:text>
														</td>
													</tr>
													<tr>
														<td>Restrito</td>
														<td >
															<html:select property="prodRstrnCode" disabled="true" styleClass="ODS_Select_Field_Size_15" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td >
															<html:select property="prodCvmTaxCode" disabled="true" styleClass="ODS_Select_Field_Size_15" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td >
															<html:select property="prodGazetaDclrFormCode" disabled="true" styleClass="ODS_Select_Field_Size_15" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td >
															<html:select property="anbidFundClassCode" styleClass="ODS_Text_Field_Size_15" disabled="true" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td >
															<html:select disabled="true" property="prodAnbidDclrCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
										     					<html:option value="N">Não Divulgar</html:option>
													...
													<tr>
														<td>Gestor</td>
														<td >
															<html:select property="prodMgmtCnpjNbr" disabled="true" styleClass="ODS_Select_Field_Size_30" disabled="true">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Administrador</td>
														<td colspan="3">
															<html:select property="prodAdminCnpjNbr" disabled="true" styleClass="ODS_Select_Field_Size_30" disabled="true">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Custodiante</td>
														<td colspan="3">
															<html:select property="prodCstdyCnpjNbr" disabled="true" styleClass="ODS_Select_Field_Size_30" disabled="true">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Auditor</td>
														<td colspan="3">
															<html:select property="prodAuditCnpjNbr" disabled="true" styleClass="ODS_Select_Field_Size_30" disabled="true">
																<html:option value=""></html:option>
											...
											<td>
												<table width="100%">
													<tr>
														<td>Emissor</td>
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" disabled="true" property="emissorProdEmissorCode">
																<html:option value=""></html:option>
													...
													<tr>
														<td>Categoria de Risco</td>
														<td>
															<html:select styleClass="ODS_Text_Field_Size_40" disabled="true" property="emissorProdRiskCatCode">
																<html:option value=""></html:option>
													...
													<tr>
														<td colspan="2">
															<html:button property="insertEmissorBtn" disabled="true" value="Incluir Emissor" onclick="submitAction('insertEmissor');"></html:button>
														</td>
													</tr>
													<tr>
														<td colspan="2">
																...
																<tbody>
																	...
																	<logic:iterate name="ProductDetailForm" property="listProductPlayerRiskVO" indexId="index" id="emissor">
																		...
																		<td width="3%">
																			...
																			name="selection"
																			onclick="javascript:emissorSeqNbr.value='<%=index%>';disableButtons(false);" disabled="true">
																		</td>
