...
<html:html>
	...
	<body>
		<html:form action="/Product.ProductDetail.Delete.Show.do">
			...
			<html:text property="backURL" value="Product.ProductDetail.Delete.Show" style="display:none"></html:text>
				...
				<tr>
					<td width="100%">
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Exclusão do Produto</th>
								</tr>
							</thead>
							<tr>
								<td>&nbsp;</td>
											...
											<td>
												<table>
													...
													<tr>
														<td>Restrito</td>
														<td colspan="3">
															<html:select property="prodRstrnCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td colspan="3">
															<html:select property="prodCvmTaxCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td colspan="3">
															<html:select property="prodGazetaDclrFormCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
													...
													<tr>
														...
														<td colspan="3">
															<html:select property="prodAnbidDclrCode" disabled="true" styleClass="ODS_Select_Field_Size_20" >
										     					<html:option value=""></html:option>
										     					<html:option value="N">Não Divulgar</html:option>
