...
<%@ page import="com.citibank.ods.modules.product.product.form.ProductMovementDetailForm"%>
...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<TITLE> Detalhe de Produto com Pendência de Aprovação </TITLE>
	</HEAD>

	<body>
		<html:form action="/Product.ProductMovementDetail.Approval.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="ProductSheet"/>
				<jsp:param name="currentSubSheet" value="Aprovação"/>
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="Product.ProductMovementDetail.Approval.Show" style="display:none"></html:text>
			<html:hidden property="noVisibleBox"></html:hidden>
			<html:hidden property="visibleBox"></html:hidden>
			<table class="ODS_mainTable" border="0" width="80%">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Detalhe de Produto com Pendência de Aprovação</th>
					</tr>
				</thead>
				<tr>
					<td>&nbsp;</td>
								...
								<td>
									<table>
										...
										<tr>
											<td>Sub-Familia</td>
											<td>
												<html:select styleClass="ODS_Text_Field_Size_40" property="prodSubFamlCode" styleId="prodSubFamlCode" onchange="submitAction('refresh');" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td>Agregador</td>
											<td>
												<html:select styleClass="ODS_Text_Field_Size_40" property="prvtProdAggrCode" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td>Veículo Legal</td>
											<td>
												<html:select property="prodLegalClassCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
											       	 <html:option value=""></html:option>
										...
										<tr>
											<td>Tipo de Ativo</td>
											<td>
												<html:select property="assetTypeCode" styleClass="ODS_Text_Field_Size_70" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											...
											<td>
							   					<html:select property="assocClassProdCode" styleClass="ODS_Text_Field_Size_70" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											...
											<td>
							   					<html:select property="prodSentIaInd" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											...
											<td>
												<html:select property="prodCrTypeClassCode" styleClass="ODS_Select_Field_Size_10" disabled="true">
											       	 <html:option value=""></html:option>
										...
										<tr>
											...
											<td colspan="2">
												<html:text styleClass="ODS_Text_Field_Size_15" property="prodAcctCode" disabled="true" maxlength="15" disabled="true"></html:text>
											</td>
										</tr>
										<tr>
											<td>Classificação Onesource</td>
											<td>
												<html:select styleClass="ODS_Text_Field_Size_40" property="assetClassOnesrc" disabled="true">
													<html:option value=""></html:option>
								...
								<td>
									<table>
										<tr>
											...
											<td colspan="3">
												<html:text styleClass="ODS_Text_Field_Size_50" property="prodOrigName" maxlength="50" disabled="true"></html:text>
											</td>
										</tr>
										<tr>
											<td>Data de Aporte</td>
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodEvnConTrbDate" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)" disabled="true"></html:text></td>
											<td>Tipo de abertura</td>
											<td>
												<html:select property="prodOpenTypCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											<td>CNPJ</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodCnpjNbr" maxlength="18" onkeyup="MaskFieldPress('CHAR','NN.NNN.NNN/NNNN-NN','left',null)" disabled="true"></html:text></td>
											<td>Perfil Fundo</td>
											<td>
												<html:select property="prodFundPrflTyp" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											<td>Conta CBLC</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodBovespaCode" maxlength="20" disabled="true"></html:text></td>
											<td>ISIN</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodIsinCode" maxlength="20" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Conta BMF</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodBmfCode" maxlength="20" disabled="true"></html:text></td>
											<td>Código ANBIMA</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodAnbidCode" maxlength="20" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Conta Selic</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodSelicCode" maxlength="20" disabled="true"></html:text></td>
											<td>Conta Cetip</td>
											<td><html:text styleClass="ODS_Text_Field_Size_15" property="prodCetipCode" maxlength="20" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Data do Evento Abertura</td>
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodOpenEvnDate" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)" disabled="true"></html:text></td>
											<td>Tipo de encerramento</td>
											<td>
												<html:select property="prodCloseTypCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
										...
										<tr>
											...
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodAdminRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodAdminRate)" disabled="true"></html:text>(%)</td>
											<td>Taxa de Performance</td>
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodPerfmRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodPerfmRate)" disabled="true"></html:text>(%)</td>
										</tr>
										<tr>
											<td>Taxa de ingresso</td>
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodPrtfinvApplRate" maxlength="10" onkeyup="NumberFieldPress('3','3','FALSE',prodPrtfinvApplRate)" disabled="true"></html:text>(%)</td>
											<td>Taxa de saída</td>
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodExitRate" maxlength="14" onkeyup="NumberFieldPress('3','5','FALSE',prodExitRate)" disabled="true"></html:text>(%)</td>
										</tr>
										<tr>
											<td>Tipo cota</td>
											<td>
												<html:select property="prodQuotTypeCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
											...
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodCloseTime" maxlength="5" onkeyup="MaskFieldPress('CHAR','NN:NN','left',null)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Cotização Aplicação D+</td>
											<td><html:text styleClass="ODS_Text_Field_Size_5" property="prodDepQuotDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" disabled="true"></html:text></td>
											<td>Liquidação de Aplicação D+</td>
											<td><html:text styleClass="ODS_Text_Field_Size_5" property="prodApplLiqDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Cotização Resgate D+</td>
											<td><html:text styleClass="ODS_Text_Field_Size_5" property="prodWthdrCrDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" disabled="true"></html:text></td>
											<td>Liquidação de Resgate D+</td>
											<td><html:text styleClass="ODS_Text_Field_Size_5" property="prodWthdrLiqDateType" maxlength="3" onkeyup="MaskFieldPress('CHAR','NNN','left',null)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Aplicação inicial mínima</td>
											<td><html:text styleClass="ODS_Text_Field_Size_20" property="prodMinStaApplAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMinStaApplAmt)" disabled="true"></html:text></td>
											<td>Resgate mínimo</td>
											<td><html:text styleClass="ODS_Text_Field_Size_20" property="prodMinWthdrAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMinWthdrAmt)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Movimentação Mínima</td>
											<td><html:text styleClass="ODS_Text_Field_Size_20" property="prodMovMinAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodMovMinAmt)" disabled="true"></html:text></td>
											<td>Valor Permanência</td>
											<td><html:text styleClass="ODS_Text_Field_Size_20" property="prodHoldMinAmt" maxlength="20" onkeyup="NumberFieldPressWithTS('15','2',prodHoldMinAmt)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Carência</td>
											<td>
												<html:select property="prodGraceInd" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					<html:option value="S">Sim</html:option>
							     					<html:option value="N">Não	</html:option>
							   					</html:select>
											...
											<td><html:text styleClass="ODS_Text_Field_Size_10" property="prodBalCloseDate" maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN','left',null)" disabled="true"></html:text></td>
										</tr>
										<tr>
											<td>Distribuição CVM</td>
											<td colspan="3">
												<html:select property="prodCvmDistCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					...
							     					<html:option value="2">Regulamentação 400</html:option>
										   					...
										   					<td>Segmento</td>	
														<td>
															<html:select property="fundDistFormTypeCode" disabled="true">
																<html:option value="">
																</html:option>
																<html:option value="SKY">
																	SKY
																</html:option>
																<html:option value="FWDGLD">
																	Forward/Gold
																</html:option>
										...
										<tr>
											<td>Condomínio</td>
											<td colspan="3">
												<html:select property="prodQuotCndmCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					...
							     					<html:option value="F">Fechado</html:option>
														...
														<td>
															<html:text property="termText" disabled="true" maxlength="50"></html:text>
														</td>
										</tr>
										<tr>
											<td>Restrito</td>
											<td colspan="3">
												<html:select property="prodRstrnCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					...
							     					<html:option value="D">Determinam por escrito a condição de solidariedade</html:option>
														...
														<td>
															<html:text disabled="true"   maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)"  property="strategyStartDate"></html:text>
														</td>
										</tr>
										<tr>
											<td>Tributação CVM</td>
											<td colspan="3">
												<html:select property="prodCvmTaxCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					...
							     					<html:option value="L">Longo</html:option>
														...
														<td>
															<html:text disabled="true"  maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)"  property="strategyCloseDate"></html:text>
														</td>
										...
										<tr>
											...
											<td colspan="3">
												<html:select property="prodGazetaDclrFormCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					...
							     					<html:option value="E">Fundos Exclusivos</html:option>
														...
														<td>
															<html:select disabled="true" property="applicationStatCode" styleClass="ODS_Select_Field_Size_15">
																 <html:option value=""></html:option>
														       	 <html:option value="A">Aberto</html:option>
														       	 <html:option value="F">Fechado</html:option>
													        </html:select>
										...
										<tr>
											...
											<td colspan="3">
												<html:select property="anbidFundClassCode" styleClass="ODS_Text_Field_Size_70" disabled="true" >
							     					<html:option value=""></html:option>
							     					<html:options property="anbidFundClassCodeDomain.columnValuesByName(ANBID_FUND_CLASS_CODE)" labelProperty="anbidFundClassCodeDomain.columnValuesByName(ANBID_FUND_CLASS_TEXT)" />
														...
														<td>
															<html:select disabled="true" property="wthdrStatCode" styleClass="ODS_Select_Field_Size_15">
																 <html:option value=""></html:option>
														       	 <html:option value="A">Aberto</html:option>
														       	 <html:option value="F">Fechado</html:option>
										...
										<tr>
											...
											<td colspan="3">
												<html:select property="prodAnbidDclrCode" styleClass="ODS_Select_Field_Size_20" disabled="true">
							     					<html:option value=""></html:option>
							     					<html:option value="N">Não Divulgar</html:option>
							     					...
							     					<html:option value="A">Aberto Mercado/Impressa</html:option>
										   				...
										   				<td>
										   					<html:text disabled="true" property="perfmRateText" maxlength="250"></html:text>
										   				</td>
										</tr>
										<tr>
											<td>Gestor</td>
											<td colspan="3">
												<html:select property="prodMgmtCnpjNbr" styleClass="ODS_Select_Field_Size_30" disabled="true">
													<html:option value=""></html:option>
													<html:options property="loadManagerDomain.columnValuesByName(PLYR_CNPJ_NBR)" labelProperty="loadManagerDomain.columnValuesByName(PLYR_NAME)" />
														...
														<td>
										   				...
										   				<td>
										   					<html:text disabled="true"  maxlength="10" onkeyup="MaskFieldPress('CHAR','NN/NN/NNNN','left',null)"  property="closeDate"></html:text>
										   				</td>
										</tr>
										<tr>
											<td>Administrador</td>
											<td colspan="3">
												<html:select property="prodAdminCnpjNbr" styleClass="ODS_Select_Field_Size_30" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td>Custodiante</td>
											<td colspan="3">
												<html:select property="prodCstdyCnpjNbr" styleClass="ODS_Select_Field_Size_30" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td>Auditor</td>
											<td colspan="3">
												<html:select property="prodAuditCnpjNbr" styleClass="ODS_Select_Field_Size_30" disabled="true">
													<html:option value=""></html:option>
								...
								<td>
									<table width="100%">
										<tr>
											<td>Emissor</td>
											<td>
												<html:select styleClass="ODS_Text_Field_Size_40" property="emissorProdEmissorCode" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td>Categoria de Risco</td>
											<td>
												<html:select styleClass="ODS_Text_Field_Size_40" property="emissorProdRiskCatCode" disabled="true">
													<html:option value=""></html:option>
										...
										<tr>
											<td colspan="2">
												<html:button property="insertEmissorBtn" value="Incluir Emissor" onclick="submitAction('insertEmissor');" disabled="true"></html:button>
											</td>
										</tr>
										<tr>
											<td colspan="2">
												...
												<table border="0" width="100%">
													<tbody>
														...
														<logic:iterate name="ProductMovementDetailForm" property="listProductPlayerRiskVO" indexId="index" id="emissor">
															...
															<td width="3%">
																<input class="radio" type="radio" name="selection" disabled="true" onclick="javascript:emissorSeqNbr.value='<%=index%>';disableButtons(false);">
															</td>
										...
										<tr>
											<td>
												<html:button property="deleteEmissorBtn" value="Excluir Emissor" disabled="true" onclick="submitAction('deleteEmissor');" disabled="true"></html:button>
											</td>
										</tr>
									</table>
								</td>											
				...
				<tr>
					<td colspan="3"><img src='<%= request.getContextPath() %>/Common/image/20grey1.gif' width="131%" height="1"></td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				<tr>
					<td colspan="3">
						<table width="100%">
							...
							<tr class="ODS_Detail_Line2">
								...
								<td width="33%"><html:text styleClass="ODS_Text_Field_Size_20" property="lastUpdDate" disabled="true"></html:text></td>
								<td width="33%"><html:text styleClass="ODS_Text_Field_Size_10" property="opernCode" disabled="true"></html:text></TD>
							</tr>
						</table>
					</td>
				</tr>
						...
						<table class="ODS_internalWidth" border="0">
							<tbody>
								<tr>
									...
									<td><html:button property="rejectBtn" value="Reprovar" onclick="submitAction('reprove');"></html:button></td>											
...
<script language="javascript">
	disableApproveButtons("<bean:write name='ProductMovementDetailForm' property='lastUpdUserId'/>","<bean:write name='ProductMovementDetailForm' property='opernCode'/>",'true');							
</script>
