...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<script language="javascript">
			function extraActions(action){
				if ( action == 'refresh' ) {
					...
					document.forms[0].action = "Product.ProductMovementDetail.Update.Show"; 
					document.forms[0].backURL.disabled = true; 
					document.forms[0].firstLoaded.value = "true";
				}
				
				if ( action == 'insertEmissor' ) {
					document.forms[0].action = "Product.ProductMovementDetail.Update.InsertEmissor"; 
					document.forms[0].backURL.disabled = true; 
				}
				if ( action == 'deleteEmissor' ) {
					document.forms[0].action = "Product.ProductMovementDetail.Update.DeleteEmissor"; 
					document.forms[0].backURL.disabled = true; 
				}				
		...
		<TITLE> Alteração do Produto com Pendência de Aprovação </TITLE>
	</HEAD>

	<body>
		<html:form action="/Product.ProductMovementDetail.Update.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="ProductSheet"/>
				<jsp:param name="currentSubSheet" value="Aprovação"/>
		    </jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="Product.ProductMovementDetail.Update.Show" style="display:none"></html:text>
			...
			<table class="ODS_mainTable" border="0">
				<thead>
					<tr>
						<th class="subtitle" scope="colgroup" colspan="3">Alteração do Produto com Pendência de Aprovação</th>
					</tr>
				</thead>
				<tr>
					<td>&nbsp;</td>
							...
							<tr>
								...
								<table class="ODS_internalWidth" border="0">
									<tbody>
										<TR>
											<TD width="100%"></TD>
											<TD><html:button property="alterBtn" value="Alterar" onclick="submitAction('update');"></html:button></TD>
