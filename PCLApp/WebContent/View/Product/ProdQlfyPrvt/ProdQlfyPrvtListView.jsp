...
<html:html>
	<HEAD><%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
		...
		<jsp:include page="/View/Util/JavascriptScreenControl.jsp" flush="true">
			<jsp:param name="pageName" value="ProdQlfyPrvt.ProdQlfyPrvtList"/>
		...
		<TITLE>Consulta de Qualificação</TITLE>
	</HEAD>

	<body>
		<html:form action="/ProdQlfyPrvt.ProdQlfyPrvtList.List.Show.do">
			<jsp:include page="/View/Util/InitialPage.jsp" flush="true">
				<jsp:param name="currentSheet" value="ProductSheet"/>
				<jsp:param name="currentSubSheet" value="Parâmetros"/>
			</jsp:include>
			<jsp:include page="/View/Util/MessageControl.jsp" flush="true"></jsp:include>
			<html:text property="backURL" value="ProdQlfyPrvt.ProdQlfyPrvtList.List.Show" style="display:none"></html:text> 
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Consulta de Qualificação</th>
								</tr>
							</thead>
							<tr>
								<td>
							...
							<tr>
								...
								<table id="gridTable" class="ODS_internalWidth" border="0">
									<tbody>
										...
										<ods:DataSetRows name="ProdQlfyPrvtListForm" property="results" dataSetRowName="resultRow" stepIndexName="step" sequenceRestartStep="2">
											...
											<bean:define name="resultRow" property="stringByName(PROD_QLFY_CODE)" id="PROD_QLFY_CODE" type="java.lang.String"></bean:define>
			 									<TD width="3%"><input type="radio" class="radio" name="selection" onclick="javascript:selectedProdQlfyCode.value='<%=PROD_QLFY_CODE%>'; disableButtons(false);"/></td>
												<TD width="87%"><bean:write name="resultRow" property="stringByName(PROD_QLFY_TEXT)"/></td>
												<TD width="10%" align="right"><bean:write name="resultRow" property="stringByName(PROD_QLFY_CODE)"/></td>
											</tr>
										</ods:DataSetRows>
									</tbody>
								</TABLE>
