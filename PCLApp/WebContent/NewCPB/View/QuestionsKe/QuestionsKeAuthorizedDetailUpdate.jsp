...
<html:html>
	...
	<body>
		<html:form action="/NEWCPB.QuestionsKeAuthorized.do" enctype="multipart/form-data"  method="POST">
				...
				<tr>
					<td width="100%">
						<table class="ODS_internalWidth" border="0">
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Conta - Incluir / Alterar Questionário K&E - Procurador/Autorizado</th>
										...
										<tr class="ODS_Detail_Line1" id="infoBaseLegalPerson">			
											<td colspan="6">										
												<table>
													...
													<tr>												
														<td colspan="4">
														 <table>														
																<tr>													
																	<TD>											
																		<html:checkbox property="questionsKeVO.acctCmplVO.agentInd" disabled="true"/>									     		   																			
																	</TD>
																	<TD>Procurador</TD>
																	<TD></TD>
																	<TD>Data de vigência</TD>
																	<TD>												
																		<html:text property="questionsKeVO.acctCmplVO.effectiveDateAgent" styleClass="ODS_Text_Field_Size_15" style="margin-left: 30px; margin-right: 70px;" 
																		maxlength="10"  disabled="true"></html:text>
																	 </TD>
																</tr>
																
																<tr>													
																	<TD>
																		<html:checkbox property="questionsKeVO.acctCmplVO.authPersonInd"  disabled="true"/>									     		   																																	
																	</TD>
																	...
																	<TD>Data de vigência</TD>
																	<TD>												
																		<html:text property="questionsKeVO.acctCmplVO.effectiveDateAuthPerson" styleClass="ODS_Text_Field_Size_15" style="margin-left: 30px; margin-right: 70px;" 
																		maxlength="10"  disabled="true"></html:text>
																	 </TD>																																	
																</tr>															
															</table>
													...
													<tr>
														<TD>(Em branco, caso de prazo indeterminado)</TD>
													</tr>
													<tr>
														<td>
														</td>
													...
													<tr>
														<TD>CPF/CNPJ do Procurador/Autorizado</TD>
														<TD>
															<html:text property="questionsKeVO.acctCmplVO.cpfCnpjNbrFormated"
															styleClass="ODS_Text_Field_Size_15"
															style="margin-left: 30px; margin-right: 70px;"
													...
													<tr>
														<TD>Nome do Procurador/Autorizado</TD>
						...
						<td colspan="3">
							<table class="ODS_internalWidth" border="0">
								<tbody>
									<tr>
										<td width="100%"></td>		
										<% if(user!=null && user.getUserAccess()!=null && user.getUserAccess().isHasAccessNovoCPBAprovRej(ScreenNamesEnum.QUESTIONS_KE_AUTH.getNome())){ %>								
											<logic:equal name="QuestionsKeForm" property="approve" value="true" >
