...
<html:html>
	<HEAD>
		...
		<jsp:include page="/NewCPB/View/Util/JavascriptScreenControl.jsp" flush="true">
			<jsp:param name="pageName" value="QuestionsKeAuthorized"/>
	...
	<html:form action="/NEWCPB.QuestionsKeAuthorized.do">	
						...
						<thead>
							<tr>
								<th class="subtitle" scope="colgroup" colspan="3">
									Conta - Consultar Questionário K&E - Procurador/Autorizado
								</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr class="ODS_Detail_line1">
								<td colspan="6">										
									<table>
										...
										<tr>
											<td>CPF/CNPJ (Procurador/Autorizado)</td>
											<td>
											...
											<TD align="left">&nbsp;Nome (Procurador/Autorizado)</TD>
										...
										<tr>
											<td>Número EM (Procurador/Autorizado)</td>
											<td>
								      ...
								      <td>
								    	<div>
											<display:table name="sessionScope.lista" uid="vo" id="vCust" pagesize="30" export="true" class="listaPaginada"  
	 											     style="width:100%" sort="list" requestURI="/FrontController/NEWCPB.QuestionsKeAuthorized?method=search" >
