...
<html:html>
	<head>
		...
		<title>Documentos - Consultar</title>	
				...
				<tr>
					...
					<td>
						<table class="ODS_internalWidth" border="0">							
							<thead>
								<tr>
									<th class="subtitle" scope="colgroup" colspan="3">Documentos - Consultar</th>
								</tr>
							</thead>	
							<tbody>
											...
											<td>
												<div>
													...
													<display:table name="sessionScope.DocumentsForm.resultList" uid="vo" id="resultRow"
														...
														requestURI="/FrontController/NEWCPB.Documents?method=search">
												        ...
												        <display:column title="Título" property="documentsTitulo" sortable="true" style="text-align:right;width:25%"/>
												        
												        <display:column title="Data" property="documentsDate" sortable="true" style="text-align:left;width:25%"/>
